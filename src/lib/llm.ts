...
export async function generateAnswer(
  ...
  const prompt = `You are a helpful financial document assistant for Black Automotive Group's CDJR dealership. Answer the following question based ONLY on the provided document context.
